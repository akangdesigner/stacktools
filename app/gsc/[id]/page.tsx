  ...
  function loadClient() {
    fetch('/api/gsc/clients')
      ...
      .then((list: GscClient[]) => {
        ...
        if (found && !found.sheet_id) setShowSheetEditor(true);
      });
  }
    ...
    <div className="p-8 max-w-4xl space-y-6">
      ...
      {!showKeywordEditor && (
        <div className="flex items-end gap-3 flex-wrap">
          ...
          <button
            onClick={handleQuery}
            disabled={loading || !endDate || !client.keywords.length || !client.sheet_id || !client.sheet_tab}
          ...
          {(!client.sheet_id || !client.sheet_tab) && (
            <p className="text-xs text-amber-600">請先設定 Sheet 才能查詢</p>
          )}
