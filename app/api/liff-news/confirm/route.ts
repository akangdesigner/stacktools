...
// 時事貼文確認：LIFF 選定文案＋圖後送來 → 查客戶 → 轉呼叫 n8n confirm webhook
// （n8n 那邊複用上傳Drive＋寫 Sheet 節點，寫進「ai小編上架文章」草稿列，是否發布=否，並推確認發佈卡）
export const dynamic = 'force-dynamic';
export const maxDuration = 120;

const N8N_CONFIRM_WEBHOOK =
  process.env.N8N_NEWS_CONFIRM_WEBHOOK ||
  'https://stack.zeabur.app/webhook/news-liff-confirm';
