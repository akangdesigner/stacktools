              ...
              <div className="pt-1 border-t border-gray-200">
                {editingNotes ? (
                  ...
                  <button
                    ...
                    className="flex items-start gap-1.5 text-xs text-gray-400 hover:text-blue-600 transition-colors text-left w-full"
                  >
                    <svg className="w-3.5 h-3.5 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                    </svg>
                    {/* 備註可能被貼入整段表格 HTML，最多顯示兩行（line-clamp-2）避免撐爆版面，點開才看全文 */}
                    <span className="line-clamp-2 break-all">{selected.notes ? selected.notes : "新增備註"}</span>
                  </button>
                )}
              </div>
            </div>
